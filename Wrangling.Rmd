...
> ANS: The expected amount of wins for that team in that year
...
```{r}
calculations<- mutate(calculations, expected_wins = payroll * wpd)
calculations
...
> ANS:  They were more efficient because from around 1996 to 2004 they won more games than they were expected to win, and overall throughout the entire time frame, had an amount of actual wins that was closer to the expected wins than the other teams on the plot. This means that they used their money efficientley.  
