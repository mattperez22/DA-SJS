...
1.  Explore the distribution of each of the `x`, `y`, and `z` variables 
    ...
    You learn the dimensions of the diamonds. x is length, y is width, z is height.
...
1.  How many diamonds are 0.99 carat? How many are 1 carat? What
    ...
    23 are 0.99 carat, 1558 are 1 carat. This is maybe because people prefer 1 carat diamonds
```{r}
